<template >
    <div class="surface-view-icon-wrapper" style="color: rgb(143, 143, 255);">
        <div class="surface-navigation-view-item-component surface-active-account-product-navigation-item"
            :class="{ 'selected': true }">
            <a class="surface-navigation-view-item-wrapper button_link" aria-label="work management"
                id="surface-account-product-727417" tabindex="-1" role="button">
                <svg width="29" height="25" viewBox="0 0 29 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M10.2475 19.2773L5.59619 12.4098L10.2475 5.54228L14.8988 12.4098L10.2475 19.2773Z"
                        fill="#C1C1FF"></path>
                    <defs>
                        <linearGradient id="paint0_linear_1640_88925" x1="18.3366" y1="19.6173" x2="15.7336"
                            y2="1.25856" gradientUnits="userSpaceOnUse">
        ...
        <div class="selected-view-indication" :class="{ 'selected': true }"> </div>
    </div>
</template>
<script>
export default {
